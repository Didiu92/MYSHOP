<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gold leading-tight">Editar categoría</h2>
    </x-slot>
        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-gray-900 shadow sm:rounded-lg p-6">
                <form action="{{ route('admin.categories.update', $category) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="space-y-2">
                        <label class="block text-sm font-medium text-gold">Imagen (opcional)</label>
                        @if($category->image)
                    ...
                    <div class="flex justify-end gap-3">
                        <a href="{{ route('admin.categories.index') }}" class="text-silver">Cancelar</a>
